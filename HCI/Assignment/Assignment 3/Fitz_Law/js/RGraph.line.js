...
RGraph.Line = function (conf) {
    ...
    */
    ...
    this.properties =
    {
        ...
        'chart.background.grid.color': '#eee',
        ...
        'chart.colors': ['#81190D', '#0A8CB5', '#00f', '#f0f', '#ff0', '#0ff', 'blue', 'pink', 'green', 'black'],
        'chart.hmargin': 0,
        ...
        'chart.filled.range.threshold.colors': ['red', 'blue'],
