...
def getAreaOfFood(img1):
    ...
    contours, hierarchy = cv2.findContours(img_th, cv2.RETR_LIST, cv2.CHAIN_APPROX_SIMPLE)[-2:] #make change here
    ...
    contours, hierarchy = cv2.findContours(img_th, cv2.RETR_LIST, cv2.CHAIN_APPROX_SIMPLE)[-2:]
...
if __name__ == '__main__':
    ...
    print("Skin Area",skin_area)
    print("Fruit Contour",fruit_contour)
    print("pix_to_cm_multiplier",pix_to_cm_multiplier)
