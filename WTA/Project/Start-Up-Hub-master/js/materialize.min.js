...
(function()
{
	...
	function e(t)
	{
		...
		return O.body.innerHTML=t,O.body.childNodes}function i(t)
		{
		...
		function n(n,s)
		{
			...
			var o,a=n,r=0;if(A(n))a=R.test(n)?x.getElementById(n.slice(1)):P.test(n)?e(n):t(n,s);
	...
	function r(t)
	{
		return A(t)?a:t.cash?function(e){return t.is(e)
	}:function(t,e){return t===e}}
	function l(t)
	{
		return s($.call(t).filter(function(t,e,i){return i.indexOf(t)===e}))
	}
	function h(t)
	{
		return t[F]=t[F]||{}
	...
	function g(t,e)
	{
		return parseInt(L.getComputedStyle(t[0],null)[e],10)||
	}
	function _(t,e,i)
	{
	...
	{
		var e=[];
		return o(t.options,function(t){t.selected&&e.push(t.value)
	}),e.length?e:null
	}
	function w(t)
	{
...
R=/^#[\w-]*$/,H=/^\.[\w-]*$/,P=/<.+>/,W=/^\w+$/,j=s.fn=s.prototype=n.prototype={cash:!0,length:0,push:D,splice:T.splice,map:T.map,init:n};
...
{t=t||{};var e=$.call(arguments),i=e.length,n=1;for(1===e.length&&(t=this,n=0);n<i;n++)if(e[n])for(var s in e[n])e[n].hasOwnProperty(s)&&(t[s]=e[n][s]);return t},
